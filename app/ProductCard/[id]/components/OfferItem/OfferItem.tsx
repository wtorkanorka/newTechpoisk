...
export function OfferItem({
  ...
  const isAddedToConfirurator = selectedOfferIsInStore({
    searchTableName: {
  ...
  function handleAddToConfigurationClick() {
    if (!isAddedToConfirurator) {
      addComponent({
    ...
    <div key={offer.id}>
      <div className="max-lg:hidden">
        <div className="flex gap-[45px] items-center justify-between">
          ...
          <button
            ...
            className={`px-[22px] py-[11px] border-solid border-[1.5px] rounded-[43px] ${
              isAddedToConfirurator || isButtonHover
                ? `border-[#FF5252]
              text-[white] bg-[#FF5252]`
                : `border-[#FF5252]
              text-[#FF5252]`
            }  text-[15px] flex gap-[10px] items-center`}
          >
            Добавить в конфигуратор
            <div
              className={`transition-all ${
                isAddedToConfirurator ? "rotate-[360deg]" : "rotate-0"
              }`}
            >
              {isAddedToConfirurator ? (
                <svg
                  width="24"
                  height="25"
                  viewBox="0 0 16 12"
      ...
      <div className="lg:hidden mx-auto max-lg:bg-[#f7f8f9] max-lg:rounded-[14px] max-lg:flex max-lg:flex-col max-lg:gap-[15px] max-lg:p-[10px]">
        <div className="flex items-center justify-between">
          ...
          >
            <Image
              width={70}
              height={70}
              src={data?.pictures[0]?.url ? data?.pictures[0]?.url : settingImg}
              alt={"empty img"}
            />
            <div>
          ...
          <button
            ...
            className={`px-[11px] py-[11px] ml-[16px] border-solid border-[1.5px] rounded-[43px] ${
              isAddedToConfirurator || isButtonHover
                ? `border-[#FF5252]
              text-[white] bg-[#FF5252]`
                : `border-[#FF5252]
        ...
        <div className="flex justify-end items-center gap-[22px]">
          <h3 className="text-[16px] font-bold max-lg:font-medium">
